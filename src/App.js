      ...
      this.state = {
         notes: [
            ...
            },
            {
               ...
               color: "#ffffff",
               tags: ["information"],
               text: "Create notes with your favorite colors and add tags to them to keep them organized.",
            },
            {
               id: "2",
               title: "One more note",
               ...
               color: "#ffffff",
               tags: ["information"],
               text: "Use the selection buttom at the upper right corner of the note to add color or delete multiple notes at the same time.",
            },
            {
               id: "3",
               title: "About",
   ...
   render() {
      return (
         <div className="App">
            ...
            <TopMenu
               onOptionsClick={this.toggleMenu}
            ...
            <div className="hbox">
               ...
               <div
                  className={`margin ${
                     this.state.sideMenuActive ? "side-active" : ""
                  }`}
               ></div>
